        ...
        <div className="policy-content">
          ...
          <div className="policy-item">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              that is not directly associated with a specific personal identity.
            </p>
          </div>
          <div className="policy-item">
            <h2 data-aos="fade-left" data-aos-delay="100">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              just after our site), the pages viewed, time spent at our website,
              and Internet Protocol (IP) addresses. An IP address is a number
              that is automatically assigned to your computer whenever you
              access the Internet. For example, when you request a page from one
              ...
              also receive personal information from third parties and other
              sources.
            </p>
          </div>
          <div className="policy-item">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              with choices relating to cookies. You have the choice to accept
              ...
              “Help” section of the toolbar. We do not link non-personal
              information from cookies to personally identifiable information
              without your permission. We use third parties to improve our
              ability to identify visitors to our website. As part of this
              service, we may make available identifiers to these third parties
              including our visitors’ IP addresses, cookies, and hashed versions
              of email addresses captured from your visit. We, and third
              parties, use this data to obtain more information about our
              visitors and reach out to them through other channels, such as
              email and/or direct mail. You have the right to opt-out of this
              activity. To opt-out, please visit grassitupshop.com/mailinglist.
            </p>
          </div>
          <div className="policy-item">
            <h2 data-aos="fade-left" data-aos-delay="100">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              register for events, apply for membership, or join technical
              committees or working groups. The types of personal information
              you provide to us on these pages may include name, address, phone
              number, email address, user IDs, passwords, billing information,
          ...
          <div className="policy-item">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              disclose in public areas of our website, such as forums, message
              boards, and news groups, becomes public information that others
              may collect, circulate, and use. Because we cannot and do not
              control the acts of others, you should exercise caution when
              deciding to disclose information about yourself or others in
              public forums such as these. You may request that we do not share
              your personal information with third parties for direct marketing
              purposes or that we delete your personal information from our
              database by contacting us at 888.449.8325 or visit
              grassitupshop.com/mailinglist to update your marketing
              preferences.
            </p>
          </div>
          <div className="policy-item">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              may provide participators with online access to their own personal
              profiles, enabling them to update or delete information at any
          ...
          <div className="policy-item">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              personal or confidential information about yourself on any
              website, including this one. Much of the personal information is
          ...
          <div className="policy-item">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              ...
              newsletters and announcements or visit
              grassitupshop.com/mailinglist to update your marketing
              preferences.
            </p>
          </div>
